...
class SocialMediaAnalyzer:
    ...
    # --------------------------- Combined ---------------------------
    def analyze_post(self, post: str) -> Dict[str, object]:
        return {
            'regex': self.extract_with_regex(post),
            'nltk': self.analyze_with_nltk(post),
            'spacy': self.analyze_with_spacy(post),
        }


def main(posts: List[str]) -> None:
